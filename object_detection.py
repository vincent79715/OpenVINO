...
def build_argparser():
    ...
    args.add_argument("-t", "--prob_threshold", help="Optional. Probability threshold for detections filtering",default=0.5, type=float)
...
def main():
    ...
    while lastkey!=27 :
        ...
        res = exec_net.infer(inputs={input_blob: img})[out_blob][0][0]
        fh,fw = frame.shape[:-1]
